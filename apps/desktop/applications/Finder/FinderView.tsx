      ...
      <div className={styles.content}>
        <div className={styles.locations}>
          ...
          <ul>
            ...
            <li><button className={`system-button ${styles['navigation-btn']} ${mobileClass}`} onClick={() => { onClickLocation('/Users/abeih/'); }}>Home</button></li>
            <li><button className={`system-button ${styles['navigation-btn']} ${mobileClass}`} onClick={() => { onClickLocation('/Users/abeih/Desktop/'); }}>Desktop</button></li>
          </ul>
        </div>
        <div className={styles.folder}>
          ...
          <FolderView directory={path} apis={application.apis} onFileOpen={onFileOpen} allowOverflow={true} appearance="finder"></FolderView>
        </div>
      </div>
    </div>
  )
